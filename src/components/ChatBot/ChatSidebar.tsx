            ...
            <div className="space-y-2">
              {sessions.length === 0 ? (
                <div className="text-center text-gray-500 py-8">
                  ...
                  <p className="text-xs text-gray-400 mt-1">Bắt đầu trò chuyện mới để khởi đầu</p>
                </div>
              ) : (
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-500 line-clamp-2 mb-2">
                          {session.lastMessage || 'Chưa có tin nhắn nào'}
                        </p>
                        <span className="text-xs text-gray-400">
                          {session.timestamp || 'Vừa xong'}
                        </span>
                      </div>
                    </div>
          ...
          <div className="p-4 border-t border-gray-200/50 bg-gray-50/50">
            <div className="text-center">
              <div className="text-xs text-gray-500 mb-2">
                Được cung cấp bởi Công nghệ AI FPT
              </div>
              <div className="text-xs text-gray-400">
                Phiên bản 2.0 • Luôn học hỏi
              </div>
            </div>
          </div>
        </div>
